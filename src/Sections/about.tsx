        ...
        <section id="about" dir={isAr ? 'rtl' : 'ltr'} className={`py-24 px-6 max-w-7xl mx-auto space-y-24 ${isAr ? 'font-arabic' : ''}`}>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative">
                    ...
                    <div className="relative z-10 rounded-[32px] overflow-hidden shadow-2xl border-8 border-white bg-school-red p-12 aspect-square flex items-center justify-center">
                        ...
                        <p className="relative z-10 text-white/90 text-2xl font-light leading-relaxed italic text-center">
                            {t.vision.description}
                        </p>
                    </div>
                </div>
